...
/* Body */
body{
 background-image:url("https://images.unsplash.com/photo-1678648113407-913545723db2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNTc5fDB8MXxhbGx8MjN8fHx8fHwyfHwxNjc4NzU2NzUz&ixlib=rb-4.0.3&q=80&w=2560") !important;
}

.flex-column div span{
 color:#f9fafa;
}
        ...
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          ...
          <div data-aos="fade-up" data-aos-delay="600">
            <?php if ($_SESSION['role'] == 'admin') {?>
              <a href="../produk/v_list_produk.php"  class="btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center">
                <span>Produk</span> 
